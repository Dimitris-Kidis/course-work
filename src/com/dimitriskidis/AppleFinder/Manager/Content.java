...
public class Content {
	...
	public static BufferedImage[][] BACKSCREEN = load("/HUD/backscreen.gif", 128, 144);
	...
	public static BufferedImage[][] APPLE = load("/Sprites/apple.gif", 16, 16);
	public static BufferedImage[][] MENUAPPLE = load("/Sprites/menuapple.gif", 16, 16);
